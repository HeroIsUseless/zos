...
static const char *const yytname[] =
{
  ...
  "'('", "')'", "$accept", "stmts", "stmt", "stmt_def", "def_var", 0
};
#endif
...
#line 38 "../../src/tools/zlang/parse.y"
    {am_define_var((yyvsp[(1) - (4)].s), (yyvsp[(3) - (4)].s), code);;}
    break;
