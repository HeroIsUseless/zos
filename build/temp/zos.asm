...
pop eax
cmp eax, ebx
jbe test_z_draw_while$1_lessequal@true$1
mov eax, 0
jmp test_z_draw_while$1_lessequal@false$1
test_z_draw_while$1_lessequal@true$1:
mov eax, 1
test_z_draw_while$1_lessequal@false$1:
push eax
pop eax
cmp eax, 0
...
mov [test_z_draw_x], eax
; while start
test_z_draw_while$1_while$1_start:
...
pop eax
cmp eax, ebx
jbe test_z_draw_while$1_while$1_lessequal@true$2
mov eax, 0
jmp test_z_draw_while$1_while$1_lessequal@false$2
test_z_draw_while$1_while$1_lessequal@true$2:
mov eax, 1
test_z_draw_while$1_while$1_lessequal@false$2:
push eax
pop eax
cmp eax, 0
je test_z_draw_while$1_while$1_end
mov eax, [test_z_draw_x]
push eax
mov eax, [test_z_draw_y]
push eax
...
pop eax
mov [test_z_draw_x], eax
jmp test_z_draw_while$1_while$1_start
test_z_draw_while$1_while$1_end:
;while end
mov eax, [test_z_draw_y]
push eax
mov eax, 1
